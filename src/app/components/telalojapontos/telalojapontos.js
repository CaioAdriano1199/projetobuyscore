    ...
    <div className="p-8 flex flex-col">
      ...
      <Modal
        ...
        <div className="grid grid-cols-5 justify-start auto-rows-max">
          <h2 className="text-2xl text-[var(--azulescuro)] font-bold text-center col-span-5 mb-4">Novo produto</h2>
          <Input labelColor="azulescuro" label="Nome do produto" colSpan="col-span-5" />
          <Input labelColor="azulescuro" label="Pontos necessários" type="number" colSpan="col-span-3" />
          <div className="flex items-center col-span-3">
          <CameraButton textolabel="Imagem Produto" labelcolor="azulescuro"/>
          </div>
